...
#define Resource_One_id 0
CONST(ResourceType, AUTOMATIC) Resource_One = Resource_One_id;

/*=============================================================================
 * Declaration of processes IDs
 */

/* Task SWC2_Task identifier */
#define SWC2_Task_id 0
CONST(TaskType, AUTOMATIC) SWC2_Task = SWC2_Task_id;

/* Task SWC1_Task identifier */
#define SWC1_Task_id 1
CONST(TaskType, AUTOMATIC) SWC1_Task = SWC1_Task_id;
...
#include "tpl_memmap.h"
/*-----------------------------------------------------------------------------
 * Resource descriptor of resource Resource_One
 *
 * Tasks which use this resource :
 * SWC1_Task
 * SWC2_Task
 */
VAR(tpl_resource, OS_VAR) Resource_One_rez_desc = {
 ...
 */
/*-----------------------------------------------------------------------------
 * Task SWC2_Task descriptor
 */
#define APP_Task_SWC2_Task_START_SEC_CODE

#include "tpl_memmap.h"
/*
 * Task SWC2_Task function prototype
 */

FUNC(void, OS_APPL_CODE) SWC2_Task_function(void);
 ...
 */
/*
 * Task SWC2_Task stack
 */
#define APP_Task_SWC2_Task_START_SEC_STACK
#include "tpl_memmap.h"
VAR(tpl_stack_word, OS_APPL_DATA) SWC2_Task_stack_zone[300/sizeof(tpl_stack_word)];
#define APP_Task_SWC2_Task_STOP_SEC_STACK
#include "tpl_memmap.h"

#define SWC2_Task_STACK {SWC2_Task_stack_zone, 300}

/*
 * Task SWC2_Task context
 */
#define OS_START_SEC_VAR_NOINIT_32BIT
#include "tpl_memmap.h"
VAR(arm_core_context, OS_VAR) SWC2_Task_int_context;

#define SWC2_Task_CONTEXT &SWC2_Task_int_context
...
/*
 * Resources used by task SWC2_Task
 *
 * Resource_One
 */

/*
 * Static descriptor of task SWC2_Task
 */
CONST(tpl_proc_static, OS_CONST) SWC2_Task_task_stat_desc = {
  /* context                  */  SWC2_Task_CONTEXT,
  /* stack                    */  SWC2_Task_STACK,
  /* entry point (function)   */  SWC2_Task_function,
  /* internal ressource       */  NULL,
  /* task id                  */  SWC2_Task_id,
#if WITH_OSAPPLICATION == YES
  /* OS application id        */  
#endif
...
#include "tpl_memmap.h"
/*
 * Dynamic descriptor of task SWC2_Task
 */
VAR(tpl_proc, OS_VAR) SWC2_Task_task_desc = {
  /* resources                      */  NULL,
#if WITH_OSAPPLICATION == YES
  /* if > 0 the process is trusted  */  0,    
#endif /* WITH_OSAPPLICATION */
...
/*-----------------------------------------------------------------------------
 * Task SWC1_Task descriptor
 */
#define APP_Task_SWC1_Task_START_SEC_CODE

#include "tpl_memmap.h"
/*
 * Task SWC1_Task function prototype
 */

FUNC(void, OS_APPL_CODE) SWC1_Task_function(void);
 ...
 */
/*
 * Task SWC1_Task stack
 */
#define APP_Task_SWC1_Task_START_SEC_STACK
#include "tpl_memmap.h"
VAR(tpl_stack_word, OS_APPL_DATA) SWC1_Task_stack_zone[300/sizeof(tpl_stack_word)];
#define APP_Task_SWC1_Task_STOP_SEC_STACK
#include "tpl_memmap.h"

#define SWC1_Task_STACK {SWC1_Task_stack_zone, 300}

/*
 * Task SWC1_Task context
 */
#define OS_START_SEC_VAR_NOINIT_32BIT
#include "tpl_memmap.h"
VAR(arm_core_context, OS_VAR) SWC1_Task_int_context;

#define SWC1_Task_CONTEXT &SWC1_Task_int_context
...
/*
 * Resources used by task SWC1_Task
 *
 * Resource_One
 */

/*
 * Static descriptor of task SWC1_Task
 */
CONST(tpl_proc_static, OS_CONST) SWC1_Task_task_stat_desc = {
  /* context                  */  SWC1_Task_CONTEXT,
  /* stack                    */  SWC1_Task_STACK,
  /* entry point (function)   */  SWC1_Task_function,
  /* internal ressource       */  NULL,
  /* task id                  */  SWC1_Task_id,
#if WITH_OSAPPLICATION == YES
  /* OS application id        */  
#endif
...
#include "tpl_memmap.h"
/*
 * Dynamic descriptor of task SWC1_Task
 */
VAR(tpl_proc, OS_VAR) SWC1_Task_task_desc = {
  /* resources                      */  NULL,
#if WITH_OSAPPLICATION == YES
  /* if > 0 the process is trusted  */  0,    
#endif /* WITH_OSAPPLICATION */
...
tpl_stat_proc_table[TASK_COUNT+ISR_COUNT+1] = {
  &SWC2_Task_task_stat_desc,
  &SWC1_Task_task_stat_desc,
